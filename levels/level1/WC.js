class WC extends Phaser.Scene {
  ...
  create() {
    ...
    let background2 = this.add.image(600, 350, "badezimmerboden");

    wand = this.physics.add.staticGroup();
    wand.create(600, 0, "blackbarH").setScale(3).refreshBody().setName("oben_wand_wc");
    wand.create(700, 650, "blackbarH").setScale(2).refreshBody().setName("unten_wand_wc");
    wand.create(220, 350, "blackbar").setScale(3.5).refreshBody().setName("links_wand_wc");
    wand.create(980, 350, "blackbar").setScale(3.5).refreshBody().setName("rechts_wand_wc");

    flurtuer = this.physics.add.staticGroup();
    ...
    // Türkollisionen mit...
    // ...Flurtür
    this.physics.add.collider(spieler, flurtuer, () => {
      this.flurtuer();
    });
  ...
  monster_KI() {
    ...
    // Wenn das Monster mit der Welt kollidiert
      ...
      // monster?.setVelocityY(this.randomIntFromInterval(-180, 180));
