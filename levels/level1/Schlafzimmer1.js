class Schlafzimmer1 extends Phaser.Scene {
  constructor() {
    super("Schlafzimmer1");
    this.x = 70;
  ...
  create() {
    ...
    let background3 = this.add.image(600, 350, "schlafzimmerboden");
    ...
    spieler = this.physics.add.sprite(1000, 350, "spieler");
    ...
    console.log(missedItemsErsteEtage);
    if ((sceneList[sceneList.length - 2] === undefined ? sceneList[sceneList.length - 1] : sceneList[sceneList.length - 2] === "Flur") && (missedItemsErsteEtage.length === 0)) {
